...
class HaivlerAPI {
  ...
  static async register(userData) {
    try {
      const response = await apiClient.post(OBFUSCATED_ENDPOINTS.REGISTER, userData);
  ...
  static async login(credentials) {
    try {
      ...
      const response = await apiClient.post(OBFUSCATED_ENDPOINTS.LOGIN, formData, {
        headers: {
  ...
  static async updateUserProfile(userData) {
    try {
      const response = await apiClient.put(OBFUSCATED_ENDPOINTS.USER_PROFILE, userData);
  ...
  static async getPost(postId) {
    try {
      const response = await apiClient.get(`${OBFUSCATED_ENDPOINTS.POSTS}/${postId}`);
      return { success: true, data: response.data };
    } catch (error) {
      return { 
        success: false, 
  ...
  static async createPost(postData) {
    try {
      ...
      const response = await apiClient.post(OBFUSCATED_ENDPOINTS.POSTS, formData, {
        headers: {
  ...
  static async updatePost(postId, postData) {
    try {
      const response = await apiClient.put(`${OBFUSCATED_ENDPOINTS.POSTS}/${postId}`, postData);
      return { success: true, data: response.data };
    } catch (error) {
      return { 
        success: false, 
  ...
  static async deletePost(postId) {
    try {
      const response = await apiClient.delete(`${OBFUSCATED_ENDPOINTS.POSTS}/${postId}`);
      return { success: true, data: response.data };
    } catch (error) {
      return { 
        success: false, 
  ...
  static async getComments(postId) {
    try {
      const response = await apiClient.get(`/api/x/ff0d498c575b/${postId}/comments`);
      return { success: true, data: response.data };
    } catch (error) {
      return { 
        success: false, 
  ...
  static async createComment(postId, content) {
    try {
      const response = await apiClient.post(`/api/x/ff0d498c575b/${postId}/comments`, {
        content
      });
      return { success: true, data: response.data };
    } catch (error) {
  ...
  static async deleteComment(commentId) {
    try {
      const response = await apiClient.delete(`/api/x/0ebcf2cda524/${commentId}`);
      return { success: true, data: response.data };
    } catch (error) {
      return { 
        success: false, 
  ...
  static async getReactions(postId) {
    try {
      const response = await apiClient.get(`/api/x/ff0d498c575b/${postId}/reactions`);
      return { success: true, data: response.data };
    } catch (error) {
      return { 
        success: false, 
  ...
  static async createReaction(postId, reactionType) {
    try {
      const response = await apiClient.post(`/api/x/ff0d498c575b/${postId}/reaction`, {
  ...
  static async deleteReaction(postId) {
    try {
      const response = await apiClient.delete(`/api/x/ff0d498c575b/${postId}/reaction`);
      return { success: true, data: response.data };
    } catch (error) {
      return { 
        success: false, 
